    ...
    function(error, response, body) {
        ...
        if(error){
            ...
            if(done == 0){
                ...
                rendered = content.toString().replace('#title#', 'Bitfinex Data Analysis')
                            .replace('#header#', headerText1)
                            .replace(/#valueData#/g, values1.toString())
                            .replace(/#xLabelData#/g, xlabels1.toString());
            }
            else{
                rendered = rendered.replace('#title#', 'Bitfinex Data Analysis')
                            .replace('#header#', headerText1)
                            .replace(/#valueData#/g, values1.toString())
                            .replace(/#xLabelData#/g, xlabels1.toString());
                res.send(rendered);
    ...
    function(error, response, body) {
        ...
        if(error){
            ...
            if(done == 0){
                ...
                rendered = content.toString().replace('#header1#', headerText2)
                            .replace('#value1Data#', values2.toString()).replace('#xLabel1Data#', xlabels2.toString());
            }
            else{
                rendered = rendered.replace('#header1#', headerText2)
                            .replace('#value1Data#', values2.toString()).replace('#xLabel1Data#', xlabels2.toString());
                res.send(rendered);
            }
        }
